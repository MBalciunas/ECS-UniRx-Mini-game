...
public partial class GameContext {
    ...
    public GameEntity SetScore(UniRx.ReactiveProperty<int> newValue) {
        if (hasScore) {
    ...
    public void ReplaceScore(UniRx.ReactiveProperty<int> newValue) {
...
public partial class GameEntity {
    ...
    public void AddScore(UniRx.ReactiveProperty<int> newValue) {
