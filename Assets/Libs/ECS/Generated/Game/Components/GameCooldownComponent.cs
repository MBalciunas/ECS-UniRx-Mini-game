...
public partial class GameEntity {
    ...
    public void AddCooldown(float newCooldown, float newLastTimeTriggered) {
        ...
        component.lastTimeTriggered = newLastTimeTriggered;
        AddComponent(index, component);
    }

    public void ReplaceCooldown(float newCooldown, float newLastTimeTriggered) {
        var index = GameComponentsLookup.Cooldown;
        var component = (CooldownComponent)CreateComponent(index, typeof(CooldownComponent));
        component.cooldown = newCooldown;
        component.lastTimeTriggered = newLastTimeTriggered;
