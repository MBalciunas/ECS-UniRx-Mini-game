...
public partial class GameContext {
    ...
    public GameEntity SetTime(float newTime, float newDeltaTime) {
        if (hasTime) {
        ...
        entity.AddTime(newTime, newDeltaTime);
        return entity;
    }

    public void ReplaceTime(float newTime, float newDeltaTime) {
        var entity = timeEntity;
        if (entity == null) {
            entity = SetTime(newTime, newDeltaTime);
        } else {
            entity.ReplaceTime(newTime, newDeltaTime);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTime(float newTime, float newDeltaTime) {
